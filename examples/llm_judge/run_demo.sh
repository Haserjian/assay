...
echo "--- What's next ---"
echo ""
echo "  Try on your own data:"
echo "    assay bundle init                    # scaffold an evidence bundle"
echo "    # fill in the 15 fields from your eval config"
echo "    assay compare baseline.json candidate.json"
echo ""
echo "  Full walkthrough: docs/outbound/TRY_YOUR_DATA.md"
echo "  Find uninstrumented LLM calls: assay scan . --report"
echo ""
